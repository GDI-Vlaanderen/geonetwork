...
<xsl:template match="//gmd:MD_DataIdentification[       ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = 'series'       or ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = 'dataset'       or ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = '']       |       //*[@gco:isoType='gmd:MD_DataIdentification' and (       ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = 'series'       or ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = 'dataset'       or ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = '')]    "
      ...
      <xsl:variable name="west"
                    select="number(gmd:extent/*/gmd:geographicElement[gmd:EX_GeographicBoundingBox/gmd:westBoundLongitude/gco:Decimal][1]/gmd:EX_GeographicBoundingBox/gmd:westBoundLongitude/gco:Decimal/text())"/>
      <xsl:variable name="east"
                    select="number(gmd:extent/*/gmd:geographicElement[gmd:EX_GeographicBoundingBox/gmd:eastBoundLongitude/gco:Decimal][1]/gmd:EX_GeographicBoundingBox/gmd:eastBoundLongitude/gco:Decimal/text())"/>
      <xsl:variable name="north"
                    select="number(gmd:extent/*/gmd:geographicElement[gmd:EX_GeographicBoundingBox/gmd:northBoundLatitude/gco:Decimal][1]/gmd:EX_GeographicBoundingBox/gmd:northBoundLatitude/gco:Decimal/text())"/>
      <xsl:variable name="south"
                    select="number(gmd:extent/*/gmd:geographicElement[gmd:EX_GeographicBoundingBox/gmd:southBoundLatitude/gco:Decimal][1]/gmd:EX_GeographicBoundingBox/gmd:southBoundLatitude/gco:Decimal/text())"/>
...
<xsl:template match="//gmd:identificationInfo/*/gmd:pointOfContact/*/gmd:organisationName    |//*[@gco:isoType='gmd:MD_DataIdentification']/gmd:pointOfContact/*/gmd:organisationName    |//*[@gco:isoType='srv:SV_ServiceIdentification']/gmd:pointOfContact/*/gmd:organisationName"
      ...
      <xsl:variable name="missing"
                    select="not(.)      or (./@gco:nilReason)      or not(../gmd:contactInfo/*/gmd:address/*/gmd:electronicMailAddress)      or (../gmd:contactInfo/*/gmd:address/*/gmd:electronicMailAddress/@gco:nilReason)"/>
      <xsl:variable name="organisationName" select="./*/text()"/>
