		...
		<gmd:graphicOverview>
			<gmd:MD_BrowseGraphic>
				<gmd:fileName>
                    ...
                    <!-- heikki: hardcoded hack around hardcoded-webapp-name problem. Asked Florin to fix it -->
                    <xsl:variable name="serverPrefix" select="concat('http://',$serverHost,':',$serverPort, '/geonetworkn1/srv/eng/resources.get?')"/>
                    <gco:CharacterString>
