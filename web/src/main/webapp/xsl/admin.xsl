						  ...
						  <xsl:when test="/root/gui/config/client/@widget='true' and /root/gui/config/client/@stateId!=''">
								...
								<xsl:call-template name="addrow">
									...
									<xsl:with-param name="content">
										<ul>
											<li>
											  <a href="{concat(/root/gui/config/client/@url, '?hl=', /root/gui/language, '&amp;s_search&amp;', '_owner=', /root/gui/session/userId)}">
													<xsl:value-of select="/root/gui/strings/mymetadata"/>
												</a>
											</li>
											<li>
											  <a href="{concat(/root/gui/config/client/@url, '?hl=', /root/gui/language, '&amp;s_search&amp;', 'siteId=', /root/gui/env/site/siteId)}">
													<xsl:value-of select="/root/gui/strings/catalogueRecords"/>
												</a>
											</li>
											<li>
											  <a href="{concat(/root/gui/config/client/@url, '?hl=', /root/gui/language, '&amp;s_search&amp;', '_isHarvested=y')}">
													<xsl:value-of select="/root/gui/strings/harvestedRecords"/>
												</a>
											</li>
											<li>
											  <a href="{concat(/root/gui/config/client/@url, '?hl=', /root/gui/language, '&amp;s_search&amp;', 'template=y')}">
                                            ...
                                            <li>
                                                <xsl:choose>
                                                    <xsl:when test="/root/gui/session/profile = 'Editor' and /root/gui/env/symbolicLocking/enable = 'false'">
                                                        <a href="{concat(/root/gui/config/client/@url, '?hl=', /root/gui/language, '&amp;s_search&amp;', '_isLocked=', 'y&amp;','_owner=', /root/gui/session/userId)}">
                                                            <xsl:value-of select="/root/gui/strings/lockedmetadata"/>
                                                        </a>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <a href="{concat(/root/gui/config/client/@url, '?hl=', /root/gui/language, '&amp;s_search&amp;', '_isLocked=', 'y')}">
                                                            <xsl:value-of select="/root/gui/strings/lockedmetadata"/>
                                                        </a>
                                                    </xsl:otherwise>
                                                </xsl:choose>
