...
/**
 * Message to instruct peer nodes in the cluster to activate the job.
 *
 * @author heikki doeleman
 */
public class HarvesterActivateMessage extends Message {

    public HarvesterActivateMessage decode(String xml) {
        XMLDecoder decoder = new XMLDecoder(new ByteArrayInputStream(xml.getBytes()));
        HarvesterActivateMessage harvestMessage = (HarvesterActivateMessage)decoder.readObject();
        decoder.close();
