...
/**
 * Message to instruct peer nodes in the cluster to remove the harvester.
 *
 * @author heikki doeleman
 */
public class HarvesterRemovedMessage extends Message {

    public HarvesterRemovedMessage decode(String xml) {
        XMLDecoder decoder = new XMLDecoder(new ByteArrayInputStream(xml.getBytes()));
        HarvesterRemovedMessage harvestMessage = (HarvesterRemovedMessage)decoder.readObject();
        decoder.close();
