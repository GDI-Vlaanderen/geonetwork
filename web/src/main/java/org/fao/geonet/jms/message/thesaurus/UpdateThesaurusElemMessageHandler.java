        ...
        // message was sent by another GN instance
            ...
            try {
                ...
                if (thesaurus != null) {
                    ...
                    if (updateThesaurusElemMessage.getWest() == null) {
                        thesaurus.updateElementWithoutSendingTopic(updateThesaurusElemMessage.getNamespace(),
                                updateThesaurusElemMessage.getNewid(),
                                updateThesaurusElemMessage.getPrefLab(), updateThesaurusElemMessage.getDefinition(),
                                updateThesaurusElemMessage.getLang());

                    } else {
                        thesaurus.updateElementWithoutSendingTopic(updateThesaurusElemMessage.getNamespace(),updateThesaurusElemMessage.getNewid(),
                                updateThesaurusElemMessage.getPrefLab(), updateThesaurusElemMessage.getDefinition(),
                                updateThesaurusElemMessage.getEast(), updateThesaurusElemMessage.getWest(),
                                updateThesaurusElemMessage.getSouth(), updateThesaurusElemMessage.getNorth(), updateThesaurusElemMessage.getLang());
                    }
                }
            }
            catch(Exception x) {
