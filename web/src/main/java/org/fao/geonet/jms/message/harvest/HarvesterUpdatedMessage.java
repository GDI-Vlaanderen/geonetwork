...
/**
 * Message to instruct peer nodes in the cluster to update the harvester.
 *
 * @author heikki doeleman
 */
public class HarvesterUpdatedMessage extends Message {

    public HarvesterUpdatedMessage decode(String xml) {
        XMLDecoder decoder = new XMLDecoder(new ByteArrayInputStream(xml.getBytes()));
        HarvesterUpdatedMessage harvestMessage = (HarvesterUpdatedMessage)decoder.readObject();
        decoder.close();
