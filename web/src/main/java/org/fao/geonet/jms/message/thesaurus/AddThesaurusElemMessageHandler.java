        ...
        // message was sent by another GN instance
            ...
            try {
                ...
                if (thesaurus != null) {
                    ...
                    if (addThesaurusElemMessage.getWest() == null) {
                        thesaurus.addElementWithoutSendingTopic(addThesaurusElemMessage.getNewid(),
                                addThesaurusElemMessage.getPrefLab(), addThesaurusElemMessage.getDefinition(), 
                                addThesaurusElemMessage.getLang());

                    } else {
                        thesaurus.addElementWithoutSendingTopic(addThesaurusElemMessage.getNewid(),
                                addThesaurusElemMessage.getPrefLab(), addThesaurusElemMessage.getDefinition(),
                                addThesaurusElemMessage.getEast(), addThesaurusElemMessage.getWest(),
                                addThesaurusElemMessage.getSouth(), addThesaurusElemMessage.getNorth(), addThesaurusElemMessage.getLang());
