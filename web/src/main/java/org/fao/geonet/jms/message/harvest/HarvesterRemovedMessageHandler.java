 ...
 */
public class HarvesterRemovedMessageHandler implements MessageHandler {

    private ServiceContext context;
    
    public HarvesterRemovedMessageHandler(ServiceContext context) {
        this.context = context;
    }
    
    public void process(String msg) throws ClusterException{
        Log.debug(Geonet.CLUSTER, "HarvesterRemovedMessageHandler processing message '" + msg + "'");

        HarvesterRemovedMessage harvesterMessage = new HarvesterRemovedMessage();
        ...
        // message was sent by another GN instance
            ...
            try {
                ...
                Log.debug(Geonet.CLUSTER, "HarvesterRemovedMessageHandler reinitializing harvestmanager");
                ...
                harvestManager.clear(dbms, harvesterMessage.getId());
            }
            catch(Exception x) {
