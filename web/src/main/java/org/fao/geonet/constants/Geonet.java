...
public class Geonet {
	...
	public class File {
		...
		public static final String UPDATE_HARVEST_INFO= "update-harvest-info.xsl";
		public static final String UPDATE_IMPORT_INFO   = "update-import-info.xsl";
	...
	public class Profile {
		...
		public static final String REVIEWER      = "Hoofdeditor";
	...
	public class Config {
		...
		public static final String STATUS_ACTIONS_CLASS = "statusActionsClass";
                public static final String VALIDATIONHOOK_CLASS = "validationHook";
  ...
  // keys for logging search log
    ...
    public class ClusterMessageTopic {
        ...
        public static final String HARVESTER_UPDATED   = "HARVESTER_UPDATED";
        public static final String HARVESTER_REMOVED   = "HARVESTER_REMOVED";
