...
public class GeonetContext
{
  ...
  public MetadataNotifierManager getMetadataNotifier() { return metadataNotifierMan; }
    ...
    public Class getValidationHookClass() { return validationHookClass; }

    private StatusActions statusActions;

    public StatusActions getStatusActions() {
        return statusActions;
    }

    public void setStatusActions(StatusActions statusActions) {
