...
//    'series': 'Séries',
    ...
    'printSel': 'Export (PDF)',
    'printSelWorkspaceCopy': 'Export workspace copy (PDF)',
    ...
    'setUnlock': 'Metadata unlock',
    'cancelEditSession': 'Cancel edit session',
    'cancelEditSessionTT': 'Unlocks the metadata record, locked in edit session',
    'changeEditSessionOwner': 'Change edit session owner',
    'changeEditSessionOwnerTT': 'Changes edit session ownership to other user',
    'items': 'éléments',
    'item': 'élément',
    'thumbnails': 'Aperçus',
    ...
    'search': 'Rechercher',
    'searchTitle': 'Search for spatial data on',
    ...
    'unlockRecordFailure': 'Error when unlocking metadata record.',
...
//    'viewWorkspaceCopyTT': 'View workspace copy of metadata record',
    'diffWorkspaceCopy': 'Compare with workspace copy',
//  'diffWorkspaceCopyTT': 'Compare with workspace copy',
    'diffWorkspaceCopyEditMode': 'Compare with workspace copy in edit mode',
    'diffOriginalCopy': 'Compare with original',
//    'diffOriginalCopyTT': 'Vergelijk met origineel',
    'diffOriginalCopyEditMode': 'Compare with original in edit mode',
