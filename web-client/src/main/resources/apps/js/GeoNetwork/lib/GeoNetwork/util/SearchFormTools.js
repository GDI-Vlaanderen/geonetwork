...
//
    ...
    /** api:method[getValidXSDField]
     *  :return: XSD Validation status field
     *
     */
    getValidXSDField: function(multi){
        var config = {
            name: 'E__valid_xsd',
            mode: 'local',
            autoSelect: false,
            triggerAction: 'all',
            fieldLabel: OpenLayers.i18n('validationStatus') + ' XSD',
            store: new Ext.data.ArrayStore({
                id: 0,
                fields: ['id', 'name'],
                data: [['1', OpenLayers.i18n('valid')],
    ...
    /** api:method[getValidIsoSchematronField]
     *  :return: ISO Schematron Validation status field
     *
     */
    getValidIsoSchematronField: function(multi){
        var config = {
            name: 'E__valid_schematron-rules-iso',
            mode: 'local',
            autoSelect: false,
            triggerAction: 'all',
            fieldLabel: OpenLayers.i18n('validationStatus') + ' ISO Schematron',
            store: new Ext.data.ArrayStore({
                id: 0,
                fields: ['id', 'name'],
                data: [['1', OpenLayers.i18n('valid')],
    ...
    /** api:method[getValidInspireSchematronField]
     *  :return: Inspire Schematron Validation status field
     *
     */
    getValidInspireSchematronField: function(multi){
        var config = {
            name: 'E__valid_schematron-rules-inspire',
            mode: 'local',
            autoSelect: false,
            triggerAction: 'all',
            fieldLabel: OpenLayers.i18n('validationStatus') + ' Inspire Schematron',
            store: new Ext.data.ArrayStore({
                id: 0,
                fields: ['id', 'name'],
                data: [['1', OpenLayers.i18n('valid')],
     ...
     *
     */
    getValidAGIVSchematronField: function(multi){
        var config = {
            name: 'E__valid_schematron-rules-agiv',
            mode: 'local',
            autoSelect: false,
            triggerAction: 'all',
            fieldLabel: OpenLayers.i18n('validationStatus') + ' AGIV Schematron',
            store: new Ext.data.ArrayStore({
                id: 0,
                fields: ['id', 'name'],
                data: [['1', OpenLayers.i18n('valid')],
