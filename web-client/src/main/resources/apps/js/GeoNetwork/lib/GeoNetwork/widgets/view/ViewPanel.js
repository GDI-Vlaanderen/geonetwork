...
GeoNetwork.view.ViewPanel = Ext.extend(Ext.Panel, {
    ...
    getLinkedData : function() {
        var store = new GeoNetwork.data.MetadataRelationStore(this.catalogue.services.mdRelation + '?type=' + this.relationTypes + '&fast=false&fromWorkspace=' + this.workspaceCopy + '&uuid=' + escape(this.metadataUuid)	, null, true),
            view = this;
        store.load();
