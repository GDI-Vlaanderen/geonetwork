...
GeoNetwork.editor.EditorTools = {
    ...
    addDateFormFieldFragment: function(fieldId){

        var xml = "<gmd:date xmlns:xlink='http://www.w3.org/1999/xlink' xmlns:gmd='http://www.isotc211.org/2005/gmd' " +
        ...
        // Create the form field and add it to the main form.
        GeoNetwork.editor.EditorTools.addHiddenFormField(fieldId, xml);
